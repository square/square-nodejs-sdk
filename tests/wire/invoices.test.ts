...
describe("InvoicesClient", () => {
    test("list", async () => {
            ...
            invoices: [
                {
                    ...
                    status: "DRAFT",
                    timezone: "America/Los_Angeles",
                    createdAt: "2030-01-13T17:45:13Z",
                    updatedAt: "2030-01-13T21:24:10Z",
                    ...
                    attachments: [
                        {
                            ...
                            hash: "273ee02cb6f5f8a3a8ca23604930dd53",
                            mimeType: "image/jpeg",
                            uploadedAt: "2030-01-13T21:24:10Z",
                        },
                    ],
        ...
        expect(expected.invoices).toEqual(page.data);
        expect(page.hasNextPage()).toBe(true);
        const nextPage = await page.getNextPage();
        expect(expected.invoices).toEqual(nextPage.data);
    });
