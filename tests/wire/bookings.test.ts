    ...
    test("create", async () => {
        ...
        expect(response).toEqual({
            booking: {
                ...
                updatedAt: "2020-10-28T15:47:41Z",
            ...
            bookings: {
                sc3p3m7dvctfr1: {
                    booking: {
                        ...
                        version: 0,
                        status: "ACCEPTED",
                        createdAt: "2023-04-26T18:19:21Z",
                        updatedAt: "2023-04-26T18:19:21Z",
                        startAt: "2023-05-01T14:00:00Z",
                        locationId: "LY6WNBPVM6VGV",
                        customerId: "4TDWKN9E8165X8Z77MRS0VFMJM",
                        appointmentSegments: [
                            {
                                durationMinutes: 60,
                                serviceVariationId: "VG4FYBKK3UL6UITOEYQ6MFLS",
                                teamMemberId: "TMjiqI3PxyLMKr4k",
                                serviceVariationVersion: BigInt("1641341724039"),
                                anyTeamMember: false,
                            },
                        ],
                        allDay: false,
                ...
                tdegug1fqni3wh: {
                    booking: {
                        ...
                        version: 0,
                        status: "ACCEPTED",
                        createdAt: "2023-04-26T18:19:30Z",
                        updatedAt: "2023-04-26T18:19:30Z",
                        startAt: "2023-05-02T14:00:00Z",
                        locationId: "LY6WNBPVM6VGV",
                        customerId: "4TDWKN9E8165X8Z77MRS0VFMJM",
                        appointmentSegments: [
                            {
        ...
        expect(response).toEqual({
            businessBookingProfile: {
                ...
                businessAppointmentSettings: {
                    locationTypes: ["BUSINESS_LOCATION"],
                    ...
                    maxAppointmentsPerDayLimit: 1,
                    cancellationWindowSeconds: 1,
    ...
    test("RetrieveLocationBookingProfile", async () => {
        ...
        expect(response).toEqual({
            locationBookingProfile: {
                locationId: "L3HETDGYQ4A2C",
                bookingSiteUrl: "https://square.site/book/L3HETDGYQ4A2C/prod-business",
    ...
    test("BulkRetrieveTeamMemberBookingProfiles", async () => {
        ...
        expect(response).toEqual({
            teamMemberBookingProfiles: {
                ...
                TMtdegug1fqni3wh: {
                    teamMemberBookingProfile: {
                        teamMemberId: "TMtdegug1fqni3wh",
                        displayName: "Sandbox Staff 2",
                        isBookable: true,
                    },
                    errors: [
                        {
