...
| `catalogObjectId` | `string \| undefined` | Optional | The ID of the [catalog object](/doc/models/catalog-object.md) to purchase to earn the number of points defined by the<br>rule. This is either an item variation or a category, depending on the type. This is defined on<br>`ITEM_VARIATION` rules and `CATEGORY` rules. |
