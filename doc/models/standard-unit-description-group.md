...
|  --- | --- | --- | --- |
| `standard_unit_descriptions` | [`StandardUnitDescription[]`](/doc/models/standard-unit-description.md) | Optional | List of standard (non-custom) measurement units in this description group. |
