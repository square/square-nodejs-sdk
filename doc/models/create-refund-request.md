...
| `tenderId` | `string` | Required | The ID of the tender to refund.<br><br>A [`Transaction`](/doc/models/transaction.md) has one or more `tenders` (i.e., methods<br>of payment) associated with it, and you refund each tender separately with<br>the Connect API.<br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `192` |
