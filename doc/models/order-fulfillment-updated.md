...
| `fulfillment_update` | [`OrderFulfillmentUpdatedUpdate[]`](/doc/models/order-fulfillment-updated-update.md) | Optional | The fulfillments that were updated with this version change. |
