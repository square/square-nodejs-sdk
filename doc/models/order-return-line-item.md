...
| `catalogObjectId` | `string` | Optional | The [CatalogItemVariation](/doc/models/catalog-item-variation.md) id applied to this returned line item.<br>**Constraints**: *Maximum Length*: `192` |
...
| `returnModifiers` | [`OrderReturnLineItemModifier[]`](/doc/models/order-return-line-item-modifier.md) | Optional | The [CatalogModifier](/doc/models/catalog-modifier.md)s applied to this line item. |
