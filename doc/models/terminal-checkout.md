...
| `device_options` | [`DeviceCheckoutOptions`](/doc/models/device-checkout-options.md) |  | - |
...
| `cancel_reason` | [`string`](/doc/models/action-cancel-reason.md) | Optional | - |
| `payment_ids` | `string[]` | Optional | A list of payments created by this `TerminalCheckout`. |
