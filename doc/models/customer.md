...
| `groupIds` | `string[] \| undefined` | Optional | The IDs of [customer groups](entity:CustomerGroup) the customer belongs to. |
| `segmentIds` | `string[] \| undefined` | Optional | The IDs of [customer segments](entity:CustomerSegment) the customer belongs to. |
