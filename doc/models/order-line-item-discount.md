...
| `pricingRuleId` | `string` | Optional | The object identifier of a [pricing rule](#type-CatalogPricingRule) to be applied automatically<br>to this discount. The specification and application of the discounts, to which a `pricing_rule_id` is<br>assigned, are completely controlled by the corresponding pricing rule. |
