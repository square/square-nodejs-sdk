...
| `device` | [`V1Device \| undefined`](../../doc/models/v1-device.md) | Optional | - |
...
| `inclusiveTax` | [`V1PaymentTax[] \| null \| undefined`](../../doc/models/v1-payment-tax.md) | Optional | All of the inclusive taxes associated with the payment. |
