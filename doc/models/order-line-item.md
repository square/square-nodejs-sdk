...
| `modifiers` | [`OrderLineItemModifier[]`](/doc/models/order-line-item-modifier.md) | Optional | The [CatalogModifier](/doc/models/catalog-modifier.md)s applied to this line item. |
