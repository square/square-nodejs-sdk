...
| `line_items` | [`OrderLineItem[]`](/doc/models/order-line-item.md) | Optional | The line items included in the order. |
...
| `service_charges` | [`OrderServiceCharge[]`](/doc/models/order-service-charge.md) | Optional | A list of service charges applied to the order. |
...
| `net_amounts` | [`OrderMoneyAmounts`](/doc/models/order-money-amounts.md) | Optional | A collection of various money amounts. |
