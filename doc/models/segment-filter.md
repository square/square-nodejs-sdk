...
|  --- | --- | --- | --- |
| `serviceVariationId` | `string` | Required | The ID of the [CatalogItemVariation](/doc/models/catalog-item-variation.md) representing the service booked in this segment.<br>**Constraints**: *Minimum Length*: `1` |
