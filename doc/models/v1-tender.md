...
| `card_brand` | [`string`](/doc/models/v1-tender-card-brand.md) | Optional | The brand of a credit card. |
| `pan_suffix` | `string` | Optional | The last four digits of the provided credit card's account number. |
| `entry_method` | [`string`](/doc/models/v1-tender-entry-method.md) | Optional | - |
...
| `tendered_money` | [`V1Money`](/doc/models/v1-money.md) | Optional | - |
...
| `change_back_money` | [`V1Money`](/doc/models/v1-money.md) | Optional | - |
