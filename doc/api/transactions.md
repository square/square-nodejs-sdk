...
const bodyAdditionalRecipients: AdditionalRecipient[] = [];
...
const bodyadditionalRecipients0: AdditionalRecipient = {
  locationId: '057P5VYJ4A5X1',
  description: 'Application fees',
  amountMoney: bodyadditionalRecipients0AmountMoney,
};
bodyadditionalRecipients0.receivableId = 'receivable_id5';
