 ...
 */
export interface ListMerchantCustomAttributesResponse {
  /**
...
export const listMerchantCustomAttributesResponseSchema: Schema<ListMerchantCustomAttributesResponse> = object(
  {
    customAttributes: [
      'custom_attributes',
