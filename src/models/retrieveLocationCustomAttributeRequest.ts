...
/** Represents a [RetrieveLocationCustomAttribute]($e/LocationCustomAttributes/RetrieveLocationCustomAttribute) request. */
export interface RetrieveLocationCustomAttributeRequest {
  /**
...
export const retrieveLocationCustomAttributeRequestSchema: Schema<RetrieveLocationCustomAttributeRequest> = object(
  {
