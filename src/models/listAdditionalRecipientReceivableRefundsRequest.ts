 ...
 */
export interface ListAdditionalRecipientReceivableRefundsRequest {
  /**
...
export const listAdditionalRecipientReceivableRefundsRequestSchema: Schema<ListAdditionalRecipientReceivableRefundsRequest> = object(
  {
