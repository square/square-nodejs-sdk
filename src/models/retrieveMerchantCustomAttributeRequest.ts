...
export interface RetrieveMerchantCustomAttributeRequest {
  /**
...
export const retrieveMerchantCustomAttributeRequestSchema: Schema<RetrieveMerchantCustomAttributeRequest> = object(
  {
