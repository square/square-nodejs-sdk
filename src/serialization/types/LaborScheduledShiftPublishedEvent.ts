...
import { LaborScheduledShiftPublishedEventData } from "./LaborScheduledShiftPublishedEventData";

export const LaborScheduledShiftPublishedEvent: core.serialization.ObjectSchema<
    serializers.LaborScheduledShiftPublishedEvent.Raw,
    Square.LaborScheduledShiftPublishedEvent
> = core.serialization.object({
    ...
    data: LaborScheduledShiftPublishedEventData.optional(),
});

export declare namespace LaborScheduledShiftPublishedEvent {
    export interface Raw {
        ...
        data?: LaborScheduledShiftPublishedEventData.Raw | null;
    }
}
