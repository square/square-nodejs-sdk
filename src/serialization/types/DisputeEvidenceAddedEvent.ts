...
import { DisputeEvidenceAddedEventData } from "./DisputeEvidenceAddedEventData";

export const DisputeEvidenceAddedEvent: core.serialization.ObjectSchema<
    serializers.DisputeEvidenceAddedEvent.Raw,
    Square.DisputeEvidenceAddedEvent
> = core.serialization.object({
    ...
    data: DisputeEvidenceAddedEventData.optional(),
});

export declare namespace DisputeEvidenceAddedEvent {
    export interface Raw {
        ...
        data?: DisputeEvidenceAddedEventData.Raw | null;
    }
}
