...
import { VendorCreatedEventData } from "./VendorCreatedEventData";

export const VendorCreatedEvent: core.serialization.ObjectSchema<
    serializers.VendorCreatedEvent.Raw,
    Square.VendorCreatedEvent
> = core.serialization.object({
    ...
    data: VendorCreatedEventData.optional(),
});

export declare namespace VendorCreatedEvent {
    export interface Raw {
        ...
        data?: VendorCreatedEventData.Raw | null;
    }
}
