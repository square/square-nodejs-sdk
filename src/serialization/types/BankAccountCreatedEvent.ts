...
import { BankAccountCreatedEventData } from "./BankAccountCreatedEventData";

export const BankAccountCreatedEvent: core.serialization.ObjectSchema<
    serializers.BankAccountCreatedEvent.Raw,
    Square.BankAccountCreatedEvent
> = core.serialization.object({
    ...
    data: BankAccountCreatedEventData.optional(),
});

export declare namespace BankAccountCreatedEvent {
    export interface Raw {
        ...
        data?: BankAccountCreatedEventData.Raw | null;
    }
}
