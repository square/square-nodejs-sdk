...
import { LaborScheduledShiftDeletedEventData } from "./LaborScheduledShiftDeletedEventData";

export const LaborScheduledShiftDeletedEvent: core.serialization.ObjectSchema<
    serializers.LaborScheduledShiftDeletedEvent.Raw,
    Square.LaborScheduledShiftDeletedEvent
> = core.serialization.object({
    ...
    data: LaborScheduledShiftDeletedEventData.optional(),
});

export declare namespace LaborScheduledShiftDeletedEvent {
    export interface Raw {
        ...
        data?: LaborScheduledShiftDeletedEventData.Raw | null;
    }
}
