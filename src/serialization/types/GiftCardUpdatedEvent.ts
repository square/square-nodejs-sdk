...
import { GiftCardUpdatedEventData } from "./GiftCardUpdatedEventData";

export const GiftCardUpdatedEvent: core.serialization.ObjectSchema<
    serializers.GiftCardUpdatedEvent.Raw,
    Square.GiftCardUpdatedEvent
> = core.serialization.object({
    ...
    data: GiftCardUpdatedEventData.optional(),
});

export declare namespace GiftCardUpdatedEvent {
    export interface Raw {
        merchant_id?: (string | null | undefined) | null;
        type?: (string | null | undefined) | null;
        event_id?: (string | null | undefined) | null;
        created_at?: string | null;
        data?: GiftCardUpdatedEventData.Raw | null;
    }
}
