...
import { CatalogVersionUpdatedEventData } from "./CatalogVersionUpdatedEventData";

export const CatalogVersionUpdatedEvent: core.serialization.ObjectSchema<
    serializers.CatalogVersionUpdatedEvent.Raw,
    Square.CatalogVersionUpdatedEvent
