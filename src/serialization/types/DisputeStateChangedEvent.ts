...
import { DisputeStateChangedEventData } from "./DisputeStateChangedEventData";

export const DisputeStateChangedEvent: core.serialization.ObjectSchema<
    serializers.DisputeStateChangedEvent.Raw,
    Square.DisputeStateChangedEvent
> = core.serialization.object({
    ...
    data: DisputeStateChangedEventData.optional(),
});

export declare namespace DisputeStateChangedEvent {
    export interface Raw {
        ...
        data?: DisputeStateChangedEventData.Raw | null;
    }
}
