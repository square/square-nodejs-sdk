...
import { InvoiceUpdatedEventData } from "./InvoiceUpdatedEventData";

export const InvoiceUpdatedEvent: core.serialization.ObjectSchema<
    serializers.InvoiceUpdatedEvent.Raw,
    Square.InvoiceUpdatedEvent
> = core.serialization.object({
    ...
    data: InvoiceUpdatedEventData.optional(),
});
...
export declare namespace InvoiceUpdatedEvent {
    export interface Raw {
        ...
        data?: InvoiceUpdatedEventData.Raw | null;
    }
}
