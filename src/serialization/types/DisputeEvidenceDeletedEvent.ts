...
import { DisputeEvidenceDeletedEventData } from "./DisputeEvidenceDeletedEventData";

export const DisputeEvidenceDeletedEvent: core.serialization.ObjectSchema<
    serializers.DisputeEvidenceDeletedEvent.Raw,
    Square.DisputeEvidenceDeletedEvent
> = core.serialization.object({
    ...
    data: DisputeEvidenceDeletedEventData.optional(),
});

export declare namespace DisputeEvidenceDeletedEvent {
    export interface Raw {
        ...
        data?: DisputeEvidenceDeletedEventData.Raw | null;
    }
}
