...
import { DisputeEvidenceRemovedEventData } from "./DisputeEvidenceRemovedEventData";

export const DisputeEvidenceRemovedEvent: core.serialization.ObjectSchema<
    serializers.DisputeEvidenceRemovedEvent.Raw,
    Square.DisputeEvidenceRemovedEvent
> = core.serialization.object({
    ...
    data: DisputeEvidenceRemovedEventData.optional(),
});

export declare namespace DisputeEvidenceRemovedEvent {
    export interface Raw {
        ...
        data?: DisputeEvidenceRemovedEventData.Raw | null;
    }
}
