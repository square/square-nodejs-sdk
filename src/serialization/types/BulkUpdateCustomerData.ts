...
export const BulkUpdateCustomerData: core.serialization.ObjectSchema<
    serializers.BulkUpdateCustomerData.Raw,
    Square.BulkUpdateCustomerData
...
export declare namespace BulkUpdateCustomerData {
