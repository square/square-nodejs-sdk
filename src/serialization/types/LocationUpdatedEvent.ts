...
import { LocationUpdatedEventData } from "./LocationUpdatedEventData";

export const LocationUpdatedEvent: core.serialization.ObjectSchema<
    serializers.LocationUpdatedEvent.Raw,
    Square.LocationUpdatedEvent
> = core.serialization.object({
    ...
    data: LocationUpdatedEventData.optional(),
});

export declare namespace LocationUpdatedEvent {
    export interface Raw {
        ...
        data?: LocationUpdatedEventData.Raw | null;
    }
}
