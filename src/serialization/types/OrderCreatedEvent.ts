...
import { OrderCreatedEventData } from "./OrderCreatedEventData";

export const OrderCreatedEvent: core.serialization.ObjectSchema<
    serializers.OrderCreatedEvent.Raw,
    Square.OrderCreatedEvent
> = core.serialization.object({
    ...
    data: OrderCreatedEventData.optional(),
});
...
export declare namespace OrderCreatedEvent {
    export interface Raw {
        ...
        data?: OrderCreatedEventData.Raw | null;
    }
}
