...
import { VendorUpdatedEventData } from "./VendorUpdatedEventData";

export const VendorUpdatedEvent: core.serialization.ObjectSchema<
    serializers.VendorUpdatedEvent.Raw,
    Square.VendorUpdatedEvent
> = core.serialization.object({
    ...
    data: VendorUpdatedEventData.optional(),
});

export declare namespace VendorUpdatedEvent {
    export interface Raw {
        ...
        data?: VendorUpdatedEventData.Raw | null;
    }
}
