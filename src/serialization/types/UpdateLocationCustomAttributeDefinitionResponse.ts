...
export const UpdateLocationCustomAttributeDefinitionResponse: core.serialization.ObjectSchema<
    serializers.UpdateLocationCustomAttributeDefinitionResponse.Raw,
