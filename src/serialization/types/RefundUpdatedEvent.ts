...
import { RefundUpdatedEventData } from "./RefundUpdatedEventData";

export const RefundUpdatedEvent: core.serialization.ObjectSchema<
    serializers.RefundUpdatedEvent.Raw,
    Square.RefundUpdatedEvent
> = core.serialization.object({
    ...
    data: RefundUpdatedEventData.optional(),
});
...
export declare namespace RefundUpdatedEvent {
    export interface Raw {
        ...
        data?: RefundUpdatedEventData.Raw | null;
    }
}
