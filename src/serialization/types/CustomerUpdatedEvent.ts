...
import { CustomerUpdatedEventData } from "./CustomerUpdatedEventData";

export const CustomerUpdatedEvent: core.serialization.ObjectSchema<
    serializers.CustomerUpdatedEvent.Raw,
    Square.CustomerUpdatedEvent
> = core.serialization.object({
    ...
    data: CustomerUpdatedEventData.optional(),
});
...
export declare namespace CustomerUpdatedEvent {
    export interface Raw {
        ...
        data?: CustomerUpdatedEventData.Raw | null;
    }
}
