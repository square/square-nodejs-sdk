...
export class CustomAttributeDefinitions {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Square.ListMerchantCustomAttributeDefinitionsResponse,
    ...
    private async __create(
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.CreateMerchantCustomAttributeDefinitionResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __get(
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.RetrieveMerchantCustomAttributeDefinitionResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __update(
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.UpdateMerchantCustomAttributeDefinitionResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __delete(
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.DeleteMerchantCustomAttributeDefinitionResponse,
                rawResponse: _response.rawResponse,
            };
        }
