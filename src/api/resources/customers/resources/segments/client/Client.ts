...
export class Segments {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Square.ListCustomerSegmentsResponse,
    ...
    private async __get(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.GetCustomerSegmentResponse, rawResponse: _response.rawResponse };
        }
