...
export class CustomAttributes {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const { customer_id: customerId, limit, cursor, with_definitions: withDefinitions } = request;
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Square.ListCustomerCustomAttributesResponse,
    ...
    private async __get(
        ...
        const { customer_id: customerId, key, with_definition: withDefinition, version } = request;
        const _queryParams: Record<string, string | string[] | object | object[] | null> = {};
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.GetCustomerCustomAttributeResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __upsert(
        ...
        const { customer_id: customerId, key, ..._body } = request;
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.UpsertCustomerCustomAttributeResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __delete(
        ...
        const { customer_id: customerId, key } = request;
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.DeleteCustomerCustomAttributeResponse,
                rawResponse: _response.rawResponse,
            };
        }
