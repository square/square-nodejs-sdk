...
export class Cards {
    ...
    private async __create(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.CreateCustomerCardResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __delete(
        ...
        const { customer_id: customerId, card_id: cardId } = request;
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return { data: _response.body as Square.DeleteCustomerCardResponse, rawResponse: _response.rawResponse };
        }
