...
export class CustomersClient {
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const _queryParams: Record<string, unknown> = {
                    ...
                    sort_field:
                        sortField !== undefined
                            ? serializers.CustomerSortField.jsonOrThrow(sortField, {
                ...
                return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v2/customers");
            },
        );
    ...
    private async __create(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/customers");
    }
    ...
    private async __batchCreate(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/customers/bulk-create");
    }
    ...
    private async __bulkDeleteCustomers(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/customers/bulk-delete");
    }
    ...
    private async __bulkRetrieveCustomers(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/customers/bulk-retrieve");
    }
    ...
    private async __bulkUpdateCustomers(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/customers/bulk-update");
    }
    ...
    private async __search(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/customers/search");
    }
    ...
    private async __get(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v2/customers/{customer_id}");
    }
    ...
    private async __update(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "PUT", "/v2/customers/{customer_id}");
    }
