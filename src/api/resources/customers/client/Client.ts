...
import { Segments } from "../resources/segments/client/Client.js";
import { Cards } from "../resources/cards/client/Client.js";
...
export class Customers {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const { cursor, limit, sort_field: sortField, sort_order: sortOrder, count } = request;
                ...
                if (_response.ok) {
                    return { data: _response.body as Square.ListCustomersResponse, rawResponse: _response.rawResponse };
                }
    ...
    private async __create(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.CreateCustomerResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __batchCreate(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.BulkCreateCustomersResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __bulkDeleteCustomers(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.BulkDeleteCustomersResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __bulkRetrieveCustomers(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.BulkRetrieveCustomersResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __bulkUpdateCustomers(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.BulkUpdateCustomersResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __search(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.SearchCustomersResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __get(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.GetCustomerResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __update(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.UpdateCustomerResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __delete(
        ...
        const { customer_id: customerId, version } = request;
        const _queryParams: Record<string, string | string[] | object | object[] | null> = {};
        ...
        if (_response.ok) {
            return { data: _response.body as Square.DeleteCustomerResponse, rawResponse: _response.rawResponse };
        }
