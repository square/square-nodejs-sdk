...
export class Codes {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Square.ListDeviceCodesResponse,
        ...
        return new core.Pageable<Square.ListDeviceCodesResponse, Square.DeviceCode>({
            ...
            getItems: (response) => response?.device_codes ?? [],
            loadPage: (response) => {
    ...
    private async __create(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.CreateDeviceCodeResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __get(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.GetDeviceCodeResponse, rawResponse: _response.rawResponse };
        }
