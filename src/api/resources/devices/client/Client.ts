...
import { Codes } from "../resources/codes/client/Client.js";
...
export class Devices {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (request: Square.ListDevicesRequest): Promise<core.WithRawResponse<Square.ListDevicesResponse>> => {
                const { cursor, sort_order: sortOrder, limit, location_id: locationId } = request;
                ...
                if (_response.ok) {
                    return { data: _response.body as Square.ListDevicesResponse, rawResponse: _response.rawResponse };
                }
    ...
    private async __get(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.GetDeviceResponse, rawResponse: _response.rawResponse };
        }
