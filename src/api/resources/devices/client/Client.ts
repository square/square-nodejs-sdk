...
export class DevicesClient {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (request: Square.ListDevicesRequest): Promise<core.WithRawResponse<Square.ListDevicesResponse>> => {
                ...
                return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v2/devices");
            },
        );
    ...
    private async __get(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v2/devices/{device_id}");
    }
}
