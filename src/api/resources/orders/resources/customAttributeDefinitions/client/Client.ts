...
export class CustomAttributeDefinitions {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const { visibility_filter: visibilityFilter, cursor, limit } = request;
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Square.ListOrderCustomAttributeDefinitionsResponse,
    ...
    private async __create(
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.CreateOrderCustomAttributeDefinitionResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __get(
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.RetrieveOrderCustomAttributeDefinitionResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __update(
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.UpdateOrderCustomAttributeDefinitionResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __delete(
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.DeleteOrderCustomAttributeDefinitionResponse,
                rawResponse: _response.rawResponse,
            };
        }
