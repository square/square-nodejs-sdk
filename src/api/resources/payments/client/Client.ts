...
export class Payments {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (request: Square.ListPaymentsRequest): Promise<core.WithRawResponse<Square.ListPaymentsResponse>> => {
                ...
                if (_response.ok) {
                    return { data: _response.body as Square.ListPaymentsResponse, rawResponse: _response.rawResponse };
                }
    ...
    private async __create(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.CreatePaymentResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __cancelByIdempotencyKey(
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.CancelPaymentByIdempotencyKeyResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __get(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.GetPaymentResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __update(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.UpdatePaymentResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __cancel(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.CancelPaymentResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __complete(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.CompletePaymentResponse, rawResponse: _response.rawResponse };
        }
