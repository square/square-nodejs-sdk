...
export class Inventory {
    ...
    private async __deprecatedGetAdjustment(
        ...
        const { adjustment_id: adjustmentId } = request;
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.GetInventoryAdjustmentResponse,
    ...
    private async __deprecatedBatchChange(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.BatchChangeInventoryResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __deprecatedBatchGetChanges(
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.BatchGetInventoryChangesResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __deprecatedBatchGetCounts(
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.BatchGetInventoryCountsResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __deprecatedGetPhysicalCount(
        ...
        const { physical_count_id: physicalCountId } = request;
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.GetInventoryPhysicalCountResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __getTransfer(
        ...
        const { transfer_id: transferId } = request;
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return { data: _response.body as Square.GetInventoryTransferResponse, rawResponse: _response.rawResponse };
        }
    ...
    public async get(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const { catalog_object_id: catalogObjectId, location_ids: locationIds, cursor } = request;
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Square.GetInventoryCountResponse,
                        rawResponse: _response.rawResponse,
                    };
                }
                if (_response.error.reason === "status-code") {
    ...
    public async changes(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Square.GetInventoryChangesResponse,
                        rawResponse: _response.rawResponse,
                    };
                }
                if (_response.error.reason === "status-code") {
