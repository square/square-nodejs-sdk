...
export class RefundsClient {
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const _queryParams: Record<string, unknown> = {
                    ...
                    limit,
                    updated_at_begin_time: updatedAtBeginTime,
                    updated_at_end_time: updatedAtEndTime,
                    sort_field:
                        sortField !== undefined
                            ? serializers.ListPaymentRefundsRequestSortField.jsonOrThrow(sortField, {
                ...
                return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v2/refunds");
            },
        );
    ...
    private async __refundPayment(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/refunds");
    }
    ...
    private async __get(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v2/refunds/{refund_id}");
    }
}
