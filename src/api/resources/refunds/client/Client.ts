...
export class Refunds {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Square.ListPaymentRefundsResponse,
    ...
    private async __refundPayment(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.RefundPaymentResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __get(
        ...
        const { refund_id: refundId } = request;
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return { data: _response.body as Square.GetPaymentRefundResponse, rawResponse: _response.rawResponse };
        }
