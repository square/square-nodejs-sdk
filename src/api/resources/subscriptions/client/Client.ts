...
export class SubscriptionsClient {
    ...
    private async __create(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/subscriptions");
    }
    ...
    private async __search(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/subscriptions/search");
    }
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SquareEnvironment.Production,
                `v2/subscriptions/${core.url.encodePathParam(subscriptionId)}`,
            ),
            method: "GET",
            headers: _headers,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SquareEnvironment.Production,
                `v2/subscriptions/${core.url.encodePathParam(subscriptionId)}/actions/${core.url.encodePathParam(actionId)}`,
            ),
            method: "DELETE",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SquareEnvironment.Production,
                `v2/subscriptions/${core.url.encodePathParam(subscriptionId)}/billing-anchor`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SquareEnvironment.Production,
                `v2/subscriptions/${core.url.encodePathParam(subscriptionId)}/cancel`,
            ),
            method: "POST",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
    ...
    public async listEvents(
        ...
        requestOptions?: SubscriptionsClient.RequestOptions,
    ): Promise<core.Page<Square.SubscriptionEvent, Square.ListSubscriptionEventsResponse>> {
                ...
                const _response = await (this._options.fetcher ?? core.fetcher)({
                    url: core.url.join(
                        (await core.Supplier.get(this._options.baseUrl)) ??
                            (await core.Supplier.get(this._options.environment)) ??
                            environments.SquareEnvironment.Production,
                        `v2/subscriptions/${core.url.encodePathParam(subscriptionId)}/events`,
                    ),
                    method: "GET",
                    headers: _headers,
                    queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
        ...
        return new core.Page<Square.SubscriptionEvent, Square.ListSubscriptionEventsResponse>({
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SquareEnvironment.Production,
                `v2/subscriptions/${core.url.encodePathParam(subscriptionId)}/pause`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SquareEnvironment.Production,
                `v2/subscriptions/${core.url.encodePathParam(subscriptionId)}/resume`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SquareEnvironment.Production,
                `v2/subscriptions/${core.url.encodePathParam(subscriptionId)}/swap-plan`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
