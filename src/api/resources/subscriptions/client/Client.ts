...
export class Subscriptions {
    ...
    public async search(
        ...
        requestOptions?: Subscriptions.RequestOptions,
    ): Promise<core.Page<Square.Subscription>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.SquareTimeoutError(
                            "Timeout exceeded when calling POST /v2/subscriptions/search.",
                        );
                    case "unknown":
                        throw new errors.SquareError({
                            message: _response.error.errorMessage,
        ...
        return new core.Pageable<Square.SearchSubscriptionsResponse, Square.Subscription>({
