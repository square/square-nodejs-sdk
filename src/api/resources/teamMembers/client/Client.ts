...
export class TeamMembersClient {
    ...
    private async __create(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/team-members");
    }
    ...
    private async __batchCreate(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/team-members/bulk-create");
    }
    ...
    private async __batchUpdate(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/team-members/bulk-update");
    }
    ...
    private async __search(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/team-members/search");
    }
