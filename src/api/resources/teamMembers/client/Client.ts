...
export class TeamMembers {
    ...
    public async search(
        ...
        requestOptions?: TeamMembers.RequestOptions,
    ): Promise<core.Page<Square.TeamMember>> {
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.SquareTimeoutError(
                            "Timeout exceeded when calling POST /v2/team-members/search.",
                        );
                    case "unknown":
                        throw new errors.SquareError({
                            message: _response.error.errorMessage,
        ...
        return new core.Pageable<Square.SearchTeamMembersResponse, Square.TeamMember>({
            response: dataWithRawResponse.data,
            rawResponse: dataWithRawResponse.rawResponse,
            hasNextPage: (response) =>
                response?.cursor != null && !(typeof response?.cursor === "string" && response?.cursor === ""),
            getItems: (response) => response?.teamMembers ?? [],
            loadPage: (response) => {
