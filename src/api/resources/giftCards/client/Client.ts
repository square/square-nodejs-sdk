...
export class GiftCardsClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<GiftCardsClient.Options>;
    ...
    public async list(
    ...
    ): Promise<core.Page<Square.GiftCard, Square.ListGiftCardsResponse>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v2/gift-cards");
            },
        );
        const dataWithRawResponse = await list(request).withRawResponse();
        return new core.Page<Square.GiftCard, Square.ListGiftCardsResponse>({
    ...
    private async __create(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/gift-cards");
    }
    ...
    private async __getFromGan(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/gift-cards/from-gan");
    }
    ...
    private async __getFromNonce(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/gift-cards/from-nonce");
    }
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SquareEnvironment.Production,
                `v2/gift-cards/${core.url.encodePathParam(giftCardId)}/link-customer`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SquareEnvironment.Production,
                `v2/gift-cards/${core.url.encodePathParam(giftCardId)}/unlink-customer`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
    ...
    private async __get(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SquareEnvironment.Production,
                `v2/gift-cards/${core.url.encodePathParam(id)}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v2/gift-cards/{id}");
    }
}
