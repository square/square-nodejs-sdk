...
import { Activities } from "../resources/activities/client/Client.js";
...
export class GiftCards {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const { type: type_, state, limit, cursor, customer_id: customerId } = request;
                ...
                if (_response.ok) {
                    return { data: _response.body as Square.ListGiftCardsResponse, rawResponse: _response.rawResponse };
                }
        ...
        return new core.Pageable<Square.ListGiftCardsResponse, Square.GiftCard>({
            ...
            getItems: (response) => response?.gift_cards ?? [],
            loadPage: (response) => {
    ...
    private async __create(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.CreateGiftCardResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __getFromGan(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.GetGiftCardFromGanResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __getFromNonce(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.GetGiftCardFromNonceResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __linkCustomer(
        ...
        const { gift_card_id: giftCardId, ..._body } = request;
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.LinkCustomerToGiftCardResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __unlinkCustomer(
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.UnlinkCustomerFromGiftCardResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __get(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.GetGiftCardResponse, rawResponse: _response.rawResponse };
        }
