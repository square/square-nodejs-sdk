...
export class OAuthClient {
    ...
    private async __revokeToken(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/oauth2/revoke");
    }
    ...
    private async __retrieveTokenStatus(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/oauth2/token/status");
    }
    ...
    private async __authorize(requestOptions?: OAuthClient.RequestOptions): Promise<core.WithRawResponse<void>> {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/oauth2/authorize");
    }
}
