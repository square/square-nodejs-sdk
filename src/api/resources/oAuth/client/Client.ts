...
export class OAuth {
    ...
    private async __revokeToken(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.RevokeTokenResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __obtainToken(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.ObtainTokenResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __retrieveTokenStatus(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.RetrieveTokenStatusResponse, rawResponse: _response.rawResponse };
        }
