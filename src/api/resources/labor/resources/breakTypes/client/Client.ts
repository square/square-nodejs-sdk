...
export class BreakTypes {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const { location_id: locationId, limit, cursor } = request;
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Square.ListBreakTypesResponse,
        ...
        return new core.Pageable<Square.ListBreakTypesResponse, Square.BreakType>({
            ...
            getItems: (response) => response?.break_types ?? [],
            loadPage: (response) => {
    ...
    private async __create(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.CreateBreakTypeResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __get(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.GetBreakTypeResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __update(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.UpdateBreakTypeResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __delete(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.DeleteBreakTypeResponse, rawResponse: _response.rawResponse };
        }
