...
export class EmployeeWages {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const { employee_id: employeeId, limit, cursor } = request;
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Square.ListEmployeeWagesResponse,
        ...
        return new core.Pageable<Square.ListEmployeeWagesResponse, Square.EmployeeWage>({
            ...
            getItems: (response) => response?.employee_wages ?? [],
            loadPage: (response) => {
    ...
    private async __get(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.GetEmployeeWageResponse, rawResponse: _response.rawResponse };
        }
