...
export class WorkweekConfigs {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Square.ListWorkweekConfigsResponse,
        ...
        return new core.Pageable<Square.ListWorkweekConfigsResponse, Square.WorkweekConfig>({
            ...
            getItems: (response) => response?.workweek_configs ?? [],
            loadPage: (response) => {
    ...
    private async __get(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.UpdateWorkweekConfigResponse, rawResponse: _response.rawResponse };
        }
