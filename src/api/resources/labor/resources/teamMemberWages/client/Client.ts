...
export class TeamMemberWages {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const { team_member_id: teamMemberId, limit, cursor } = request;
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Square.ListTeamMemberWagesResponse,
        ...
        return new core.Pageable<Square.ListTeamMemberWagesResponse, Square.TeamMemberWage>({
            ...
            getItems: (response) => response?.team_member_wages ?? [],
            loadPage: (response) => {
    ...
    private async __get(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.GetTeamMemberWageResponse, rawResponse: _response.rawResponse };
        }
