...
export class LaborClient {
    ...
    private async __createScheduledShift(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/labor/scheduled-shifts");
    }
    ...
    private async __createTimecard(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/labor/timecards");
    }
    ...
    private async __searchTimecards(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/labor/timecards/search");
    }
    ...
    private async __retrieveTimecard(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v2/labor/timecards/{id}");
    }
    ...
    private async __updateTimecard(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "PUT", "/v2/labor/timecards/{id}");
    }
    ...
    private async __deleteTimecard(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "DELETE", "/v2/labor/timecards/{id}");
    }
}
