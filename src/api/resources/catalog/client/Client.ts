...
export class CatalogClient {
    ...
    private async __batchDelete(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/catalog/batch-delete");
    }
    ...
    private async __batchGet(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/catalog/batch-retrieve");
    }
    ...
    private async __batchUpsert(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/catalog/batch-upsert");
    }
     ...
     */
    public info(requestOptions?: CatalogClient.RequestOptions): core.HttpResponsePromise<Square.CatalogInfoResponse> {
    ...
    private async __info(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v2/catalog/info");
    }
    ...
    public async list(
        ...
        requestOptions?: CatalogClient.RequestOptions,
    ): Promise<core.Page<Square.CatalogObject, Square.ListCatalogResponse>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (request: Square.ListCatalogRequest): Promise<core.WithRawResponse<Square.ListCatalogResponse>> => {
                ...
                return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v2/catalog/list");
            },
        );
        const dataWithRawResponse = await list(request).withRawResponse();
        return new core.Page<Square.CatalogObject, Square.ListCatalogResponse>({
    ...
    private async __search(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/catalog/search");
    }
