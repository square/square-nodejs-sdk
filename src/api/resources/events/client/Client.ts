...
export class Events {
    ...
    private async __searchEvents(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.SearchEventsResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __disableEvents(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.DisableEventsResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __enableEvents(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.EnableEventsResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __listEventTypes(
        ...
        const { api_version: apiVersion } = request;
        ...
        if (_response.ok) {
            return { data: _response.body as Square.ListEventTypesResponse, rawResponse: _response.rawResponse };
        }
