...
export class Employees {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const { location_id: locationId, status, limit, cursor } = request;
                ...
                if (_response.ok) {
                    return { data: _response.body as Square.ListEmployeesResponse, rawResponse: _response.rawResponse };
                }
    ...
    private async __get(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.GetEmployeeResponse, rawResponse: _response.rawResponse };
        }
