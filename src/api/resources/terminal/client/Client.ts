...
import { Actions } from "../resources/actions/client/Client.js";
import { Checkouts } from "../resources/checkouts/client/Client.js";
import { Refunds } from "../resources/refunds/client/Client.js";
...
export class Terminal {
    ...
    private async __dismissTerminalAction(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.DismissTerminalActionResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __dismissTerminalCheckout(
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.DismissTerminalCheckoutResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __dismissTerminalRefund(
        ...
        const { terminal_refund_id: terminalRefundId } = request;
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return { data: _response.body as Square.DismissTerminalRefundResponse, rawResponse: _response.rawResponse };
        }
