...
export class Checkouts {
    ...
    public async search(
        ...
        requestOptions?: Checkouts.RequestOptions,
    ): Promise<core.Page<Square.TerminalCheckout>> {
        ...
        return new core.Pageable<Square.SearchTerminalCheckoutsResponse, Square.TerminalCheckout>({
            response: dataWithRawResponse.data,
            rawResponse: dataWithRawResponse.rawResponse,
            hasNextPage: (response) =>
                response?.cursor != null && !(typeof response?.cursor === "string" && response?.cursor === ""),
            getItems: (response) => response?.checkouts ?? [],
            loadPage: (response) => {
