...
export class V1TransactionsClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<V1TransactionsClient.Options>;
    ...
    private async __v1ListOrders(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v1/{location_id}/orders");
    }
