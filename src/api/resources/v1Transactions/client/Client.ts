...
export class V1Transactions {
    ...
    private async __v1ListOrders(
        ...
        const { location_id: locationId, order, limit, batch_token: batchToken } = request;
        ...
        if (_response.ok) {
            return { data: _response.body as Square.V1Order[], rawResponse: _response.rawResponse };
        }
    ...
    private async __v1RetrieveOrder(
        ...
        const { location_id: locationId, order_id: orderId } = request;
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
    ...
    private async __v1UpdateOrder(
        ...
        const { location_id: locationId, order_id: orderId, ..._body } = request;
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
