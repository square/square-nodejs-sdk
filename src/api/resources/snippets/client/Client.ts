...
export class Snippets {
    ...
    private async __get(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.GetSnippetResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __upsert(
        ...
        const { site_id: siteId, ..._body } = request;
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return { data: _response.body as Square.UpsertSnippetResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __delete(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.DeleteSnippetResponse, rawResponse: _response.rawResponse };
        }
