...
import { Evidence } from "../resources/evidence/client/Client.js";
...
export class Disputes {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (request: Square.ListDisputesRequest): Promise<core.WithRawResponse<Square.ListDisputesResponse>> => {
                const { cursor, states, location_id: locationId } = request;
                ...
                if (_response.ok) {
                    return { data: _response.body as Square.ListDisputesResponse, rawResponse: _response.rawResponse };
                }
    ...
    private async __get(
        ...
        const { dispute_id: disputeId } = request;
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return { data: _response.body as Square.GetDisputeResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __accept(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.AcceptDisputeResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __createEvidenceFile(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.SquareEnvironment.Production,
                `v2/disputes/${encodeURIComponent(request.dispute_id)}/evidence-files`,
            ),
            method: "POST",
            headers: mergeHeaders(
                this._options?.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.CreateDisputeEvidenceFileResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __createEvidenceText(
        ...
        const { dispute_id: disputeId, ..._body } = request;
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.CreateDisputeEvidenceTextResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __submitEvidence(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.SubmitEvidenceResponse, rawResponse: _response.rawResponse };
        }
