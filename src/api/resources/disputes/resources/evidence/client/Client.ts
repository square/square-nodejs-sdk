...
export class Evidence {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const { dispute_id: disputeId, cursor } = request;
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Square.ListDisputeEvidenceResponse,
    ...
    private async __get(
        ...
        const { dispute_id: disputeId, evidence_id: evidenceId } = request;
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
        ...
        if (_response.ok) {
            return { data: _response.body as Square.GetDisputeEvidenceResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __delete(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.DeleteDisputeEvidenceResponse, rawResponse: _response.rawResponse };
        }
