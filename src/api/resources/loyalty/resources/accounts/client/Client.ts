...
export class Accounts {
    ...
    private async __create(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.CreateLoyaltyAccountResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __search(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.SearchLoyaltyAccountsResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __get(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.GetLoyaltyAccountResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __accumulatePoints(
        ...
        if (_response.ok) {
            return {
                data: _response.body as Square.AccumulateLoyaltyPointsResponse,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __adjust(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.AdjustLoyaltyPointsResponse, rawResponse: _response.rawResponse };
        }
