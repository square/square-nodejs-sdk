...
export class Accounts {
    ...
    public async search(
        ...
        requestOptions?: Accounts.RequestOptions,
    ): Promise<core.Page<Square.LoyaltyAccount>> {
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.SquareTimeoutError(
                            "Timeout exceeded when calling POST /v2/loyalty/accounts/search.",
                        );
                    case "unknown":
                        throw new errors.SquareError({
                            message: _response.error.errorMessage,
        ...
        return new core.Pageable<Square.SearchLoyaltyAccountsResponse, Square.LoyaltyAccount>({
            response: dataWithRawResponse.data,
            rawResponse: dataWithRawResponse.rawResponse,
            hasNextPage: (response) =>
                response?.cursor != null && !(typeof response?.cursor === "string" && response?.cursor === ""),
            getItems: (response) => response?.loyaltyAccounts ?? [],
            loadPage: (response) => {
