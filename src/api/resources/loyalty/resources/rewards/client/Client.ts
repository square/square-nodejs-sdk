...
export class Rewards {
    ...
    public async search(
        ...
        requestOptions?: Rewards.RequestOptions,
    ): Promise<core.Page<Square.LoyaltyReward>> {
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.SquareTimeoutError(
                            "Timeout exceeded when calling POST /v2/loyalty/rewards/search.",
                        );
                    case "unknown":
                        throw new errors.SquareError({
                            message: _response.error.errorMessage,
        ...
        return new core.Pageable<Square.SearchLoyaltyRewardsResponse, Square.LoyaltyReward>({
            response: dataWithRawResponse.data,
            rawResponse: dataWithRawResponse.rawResponse,
            hasNextPage: (response) =>
                response?.cursor != null && !(typeof response?.cursor === "string" && response?.cursor === ""),
            getItems: (response) => response?.rewards ?? [],
            loadPage: (response) => {
