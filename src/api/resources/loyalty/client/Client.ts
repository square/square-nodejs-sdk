...
import { Programs } from "../resources/programs/client/Client.js";
...
export class Loyalty {
    ...
    private async __searchEvents(
        ...
        if (_response.ok) {
            return { data: _response.body as Square.SearchLoyaltyEventsResponse, rawResponse: _response.rawResponse };
        }
