...
export class BookingsClient {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (request: Square.ListBookingsRequest): Promise<core.WithRawResponse<Square.ListBookingsResponse>> => {
                ...
                return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v2/bookings");
            },
        );
    ...
    private async __create(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/bookings");
    }
    ...
    private async __bulkRetrieveBookings(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/bookings/bulk-retrieve");
    }
    ...
    private async __get(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v2/bookings/{booking_id}");
    }
    ...
    private async __update(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "PUT", "/v2/bookings/{booking_id}");
    }
