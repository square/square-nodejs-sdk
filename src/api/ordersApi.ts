...
export class OrdersApi extends BaseApi {
  ...
  async createOrder(
    ...
    req.appendTemplatePath`/v2/locations/${mapped.locationId}/orders`;
  ...
  async batchRetrieveOrders(
    ...
    req.json(mapped.body);
    req.appendTemplatePath`/v2/locations/${mapped.locationId}/orders/batch-retrieve`;
  ...
  async updateOrder(
    ...
    req.json(mapped.body);
    req.appendTemplatePath`/v2/locations/${mapped.locationId}/orders/${mapped.orderId}`;
