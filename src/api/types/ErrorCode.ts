...
export const ErrorCode = {
    ...
    PlaidErrorInvalidAccessToken: "PLAID_ERROR_INVALID_ACCESS_TOKEN",
    PlaidErrorInvalidAccountId: "PLAID_ERROR_INVALID_ACCOUNT_ID",
    PlaidErrorNoAccounts: "PLAID_ERROR_NO_ACCOUNTS",
    PlaidErrorItemNotFound: "PLAID_ERROR_ITEM_NOT_FOUND",
    PlaidErrorInsufficientCredentials: "PLAID_ERROR_INSUFFICIENT_CREDENTIALS",
    PlaidErrorItemNotSupported: "PLAID_ERROR_ITEM_NOT_SUPPORTED",
    PlaidErrorProductNotReady: "PLAID_ERROR_PRODUCT_NOT_READY",
    ...
    CartIneligibleForEbt: "CART_INELIGIBLE_FOR_EBT",
    NotFound: "NOT_FOUND",
