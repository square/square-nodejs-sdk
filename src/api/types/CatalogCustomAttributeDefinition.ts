...
export interface CatalogCustomAttributeDefinition {
     ...
     */
    source_application?: Square.SourceApplication;
    /**
     ...
     */
    allowed_object_types: Square.CatalogObjectType[];
    /**
     ...
     */
    app_visibility?: Square.CatalogCustomAttributeDefinitionAppVisibility;
    /** Optionally, populated when `type` = `STRING`, unset otherwise. */
    string_config?: Square.CatalogCustomAttributeDefinitionStringConfig;
