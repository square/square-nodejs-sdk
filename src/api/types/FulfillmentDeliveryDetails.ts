...
export interface FulfillmentDeliveryDetails {
     ...
     */
    schedule_type?: Square.FulfillmentDeliveryDetailsOrderFulfillmentDeliveryDetailsScheduleType;
    /**
     ...
     * The duration must be in RFC 3339 format (for example, "P1W3D").
     */
    delivery_window_duration?: string | null;
    /**
     ...
     * The duration must be in RFC 3339 format (for example, "P1W3D").
     */
    courier_pickup_window_duration?: string | null;
    /** Whether the delivery is preferred to be no contact. */
    is_no_contact_delivery?: boolean | null;
    ...
    courier_support_phone_number?: string | null;
    /** The identifier for the delivery created by Square. */
    square_delivery_id?: string | null;
