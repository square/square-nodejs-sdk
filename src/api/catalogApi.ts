...
export class CatalogApi extends BaseApi {
  ...
  /**
   * Uploads an image file to be represented by an [CatalogImage](#type-catalogimage) object linked to an
   * existing
   ...
   *                                           CatalogTax objects, CatalogImages and CatalogModifierLists will be
